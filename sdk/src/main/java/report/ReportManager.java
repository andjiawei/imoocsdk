...
import module.monitor.Monitor;
import response.HttpConstant.Params;
...
public class ReportManager {
    ...
    public static void sendAdMonitor(boolean isPad, String sid, String ie, String appVersion, Params step, String result) {
        RequestParams params = new RequestParams();
        params.put(response.HttpConstant.Params.lvs.getKey(), response.HttpConstant.Params.lvs.getValue());
