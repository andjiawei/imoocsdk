...
public class HotSalePagerAdapter extends PagerAdapter {
    ...
    public HotSalePagerAdapter(Context context, List<RecommandModel.DataBean.ListBean> list) {
        mContext = context;
        mData = list;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        final RecommandModel.DataBean.ListBean value = mData.get(position % mData.size());
