package com.example.jiawei.imoocsdk.utils;
...
public class Utils {
    ...
    //为ViewPager结构化数据
    public static ArrayList<RecommandModel.DataBean.ListBean> handleData(RecommandModel.DataBean.ListBean value) {
        ArrayList<RecommandModel.DataBean.ListBean> values = new ArrayList<>();
        ...
        for (int i = 0; i < titles.length; i++) {
            RecommandModel.DataBean.ListBean tempValue = new RecommandModel.DataBean.ListBean();
