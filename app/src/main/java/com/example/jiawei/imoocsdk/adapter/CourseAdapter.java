package com.example.jiawei.imoocsdk.adapter;
...
import com.example.jiawei.imoocsdk.utils.Utils;
...
import core.video.VideoAdContext;
...
public class CourseAdapter extends BaseAdapter {
    ...
    private List<RecommandModel.DataBean.ListBean> mData;
    private ViewHolder mViewHolder;
//    private VideoAdContext mAdsdkContext;
    private ImageLoaderUtil mImagerLoader;
    private VideoAdContext mAdsdkContext;

    public CourseAdapter(Context context, List<RecommandModel.DataBean.ListBean> data) {
        mContext = context;
        mData = data;
    ...
    public int getItemViewType(int position) {
        RecommandModel.DataBean.ListBean value = (RecommandModel.DataBean.ListBean) getItem(position);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final RecommandModel.DataBean.ListBean value = (RecommandModel.DataBean.ListBean) getItem(position);
        //无tag时
        if (convertView == null) {
            switch (type) {
                case VIDOE_TYPE:
                ...
                case CARD_TYPE_THREE:
                    ...
                    //add data
                    ArrayList<RecommandModel.DataBean.ListBean> recommandList = Utils.handleData(value);
                    mViewHolder.mViewPager.setPageMargin(24);
